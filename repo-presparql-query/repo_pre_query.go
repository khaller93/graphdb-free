...
// checks whether the given query is in the list of queries.
...
// response type for the execution of a query.
...
// gets the repository ID from the configuration file in turtle syntax.
...
// waiting for the GraphDB on the given port to be reachable.
...
// gets all the queries that have been specified in the
// sparql.lock file, meaning they already have been
// initialized.
...
// writes the successfully initialized queries to the SPARQL lock.
