...
// scans the given directory for sub folders which might contain the
...
// scans the given directory for files with the file ending '.sparql' and
// returns a list of paths to them.
